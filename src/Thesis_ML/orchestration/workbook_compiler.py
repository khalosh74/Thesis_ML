...
from Thesis_ML.orchestration.study_review import (
    append_warning as _append_warning,
)
from Thesis_ML.orchestration.study_review import (
    build_study_review as _build_study_review,
)
from Thesis_ML.orchestration.workbook_study_design_layer import (
    build_study_design_layer as _build_study_design_layer_impl,
)
...
def _build_study_design_layer(
    ...
    return _build_study_design_layer_impl(
        workbook,
        _sheet_rows=_sheet_rows,
        _STUDY_DESIGN_REQUIRED_COLUMNS=_STUDY_DESIGN_REQUIRED_COLUMNS,
        _normalize_text=_normalize_text,
        _read_cell=_read_cell,
        _parse_enabled=_parse_enabled,
        StudyType=StudyType,
        StudyIntent=StudyIntent,
        _parse_optional_yes_no=_parse_optional_yes_no,
        _validated_section=_validated_section,
        SectionName=SectionName,
        _FACTOR_COLUMNS=_FACTOR_COLUMNS,
        _parse_levels=_parse_levels,
        FactorSpec=FactorSpec,
        _FIXED_CONTROL_COLUMNS=_FIXED_CONTROL_COLUMNS,
        FixedControlSpec=FixedControlSpec,
        _parse_scalar_value=_parse_scalar_value,
        _CONSTRAINT_COLUMNS=_CONSTRAINT_COLUMNS,
        ConstraintSpec=ConstraintSpec,
        _BLOCKING_AND_REPLICATION_COLUMNS=_BLOCKING_AND_REPLICATION_COLUMNS,
        BlockingReplicationSpec=BlockingReplicationSpec,
        _GENERATED_DESIGN_MATRIX_COLUMNS=_GENERATED_DESIGN_MATRIX_COLUMNS,
        _parse_json_object=_parse_json_object,
        _STUDY_RIGOR_CHECKLIST_COLUMNS=_STUDY_RIGOR_CHECKLIST_COLUMNS,
        _CHECKLIST_YES_NO_COLUMNS=_CHECKLIST_YES_NO_COLUMNS,
        _parse_yes_no=_parse_yes_no,
        StudyRigorChecklistSpec=StudyRigorChecklistSpec,
        _ANALYSIS_PLAN_COLUMNS=_ANALYSIS_PLAN_COLUMNS,
        AnalysisPlanSpec=AnalysisPlanSpec,
        StudyDesignSpec=StudyDesignSpec,
        _build_study_review=_build_study_review,
        _append_warning=_append_warning,
        _enum_text=_enum_text,
        _fixed_controls_map=_fixed_controls_map,
        _repeat_plan_for_study=_repeat_plan_for_study,
        _is_disallowed_combination=_is_disallowed_combination,
        _build_custom_matrix_cells=_build_custom_matrix_cells,
        _build_factorial_cells=_build_factorial_cells,
        _trial_spec_from_cell=_trial_spec_from_cell,
        _default_stage_for_study=_default_stage_for_study,
    )
