...
DEFAULT_COMPARISON_SPEC_PATH = DEFAULT_COMPARISON_SPEC_DIR / "model_family_comparison_v1.json"
DEFAULT_PROTOCOLS_DIR = PROJECT_ROOT / "configs" / "protocols"
DEFAULT_TARGET_CONFIGS_DIR = PROJECT_ROOT / "configs" / "targets"
DEFAULT_THESIS_PROTOCOL_PATH = DEFAULT_PROTOCOLS_DIR / "thesis_canonical_v1.json"
DEFAULT_THESIS_CONFIRMATORY_PROTOCOL_PATH = DEFAULT_PROTOCOLS_DIR / "thesis_confirmatory_v1.json"
DEFAULT_THESIS_NESTED_PROTOCOL_PATH = DEFAULT_PROTOCOLS_DIR / "thesis_canonical_nested_v1.json"
