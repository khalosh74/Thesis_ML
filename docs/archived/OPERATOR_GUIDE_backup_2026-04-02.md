# Backup: OPERATOR_GUIDE.md

This is an archived backup copy of `docs/OPERATOR_GUIDE.md` created on 2026-04-02 by the repository agent during a documentation consolidation operation. The original content follows.
