...
def fill_decision_log_sheet(ws) -> int:
    ...
    rows = [
        ...
        (
            ...
            "Whole-brain masked voxels; atlas-derived sensory ROI masked voxels",
            "E10",
...
def fill_thesis_map_sheet(ws) -> int:
    ...
    rows = [
        ...
        (
            ...
            "Chapter 3",
            "3.2 Feature space",
            "Whole-brain vs atlas-derived sensory ROI voxel comparison",
            "Supporting",
            "Method choice",
            "Advisory ROI sensitivity check with common valid sample support (not a lock dependency)",
            "",
        ),
        (
            "E10",
